 ...
 */
final class Version20240303180738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, avis_id INT DEFAULT NULL, sujet VARCHAR(255) NOT NULL, description_rec VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, reponse VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_CE606404197E709F (avis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
