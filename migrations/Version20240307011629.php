 ...
 */
final class Version20240307011629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE progress_bar (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, target INT NOT NULL, current INT NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_FFD045AAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
