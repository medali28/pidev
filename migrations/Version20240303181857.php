 ...
 */
final class Version20240303181857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD patient_id INT DEFAULT NULL, ADD medecin_id INT DEFAULT NULL, ADD date_rec DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation DROP patient_id, DROP medecin_id, DROP date_rec');
    }
}
